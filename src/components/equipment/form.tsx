...
import { Monitor, Tv, AirVent, Projector, Speaker, Fan, Presentation } from "lucide-react"
...
import { useCreateEquipmentMutation } from "~/hooks/api/device/use-create-equipment-mutation"
import { EquipmentCreate, deviceCreateSchema } from "~/lib/validations/device"

interface EquipmentCreateFormProps {
  setIsOpen: (isOpen: boolean) => void
}

export default function EquipmentCreateForm({ setIsOpen }: EquipmentCreateFormProps) {
  ...
  const SelectedIcon = equipmentTypes.find((type) => type.value === selectedType)?.icon || Monitor
            ...
            <FormItem>
              ...
              <FormControl>
                <div className="relative">
                  ...
                  <Input placeholder={`Enter ${selectedType} name`} {...field} className="pl-10" />
                </div>
              </FormControl>
              <FormMessage />
            </FormItem>
